...
from graphrag.query.context_builder.node_only import NodeOnlyContextBuilder
...
def get_local_search_engine(
    ...
    extra_context_builder_params: dict | None = None,  # NEW optional param
) -> LocalSearch:
    ...
    # existing context builder params (from config)
    base_context_builder_params = {
    ...
    # merge extra params if provided (extra overrides base)
    if extra_context_builder_params:
        merged_context_builder_params = {**base_context_builder_params, **extra_context_builder_params}
    else:
        merged_context_builder_params = base_context_builder_params

    return LocalSearch(
        model=chat_model,
        system_prompt=system_prompt,
        #変更始
        context_builder=NodeOnlyContextBuilder(
        model_name=config.local_search.chat_model_id,
        default_max_context_tokens=ls_config.max_context_tokens,
        ),
        #変更終
        tokenizer=tokenizer,
        model_params=model_params,
        context_builder_params=merged_context_builder_params,

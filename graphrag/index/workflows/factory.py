...
# --- 新規 TF-IDF 文書丸ごと1ノードワークフローの登録 ---
_tfidf_workflows = [
    "create_doc_text_units",  # 文書丸ごと1ノード
    "create_final_documents",
    "tfidf_extract_graph",         # TF-IDF ハイパーエッジ作成
    "finalize_graph",
    #"extract_covariates",
    #"create_communities",
    #"create_final_text_units",
...
PipelineFactory.register_pipeline(
    IndexingMethod.TFIDF_DocNode, ["load_input_documents", *_tfidf_workflows]
)
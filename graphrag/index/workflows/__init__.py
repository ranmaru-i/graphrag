...
from .create_doc_text_units import (
    run_workflow as run_create_doc_text_units,
)
from .tfidf_extract_graph import (
    run_workflow as run_tfidf_extract_graph,
)
from .create_community_reports_tfidf import (
    run_workflow as run_create_community_reports_tfidf,
)
...
PipelineFactory.register_all({
    ...
    "create_doc_text_units": run_create_doc_text_units,
    "tfidf_extract_graph": run_tfidf_extract_graph,
    "create_community_reports_tfidf": run_create_community_reports_tfidf,
})